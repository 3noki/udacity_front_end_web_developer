...
//open the card on a click and push it to an array to track, if it's two check if there's a match
...
function reduceStars() {
  if (clicks <=16) {}
    ...
    var item = document.getElementById("3rd-star");
    item.parentNode.removeChild(item);
    stars--;
  }
  else {
